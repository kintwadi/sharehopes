...
const translations = {
  "en": {
        ...
        "partner-desc": "Collaborate with Shared Hope",
  ...
  "de": {
        ...
        "partner-desc": "Arbeiten Sie mit Shared Hope zusammen",
  ...
  "es": {
        ...
        "partner-desc": "Colabora con Shared Hope",
  ...
  "pt": {
        ...
        "partner-desc": "Colabore com a Shared Hope",
...
document.addEventListener('DOMContentLoaded', function() {
  try {
    ...
    // Initialize Tom Select enhanced dropdowns
    (async () => {
      const lang = getInitialLanguage();
      await loadCountries();
      const countryOptions = countryList[lang] || countryList.en;
      // Initialize Tom Select for country
      window.countryTS = new TomSelect('#country', {
        valueField: 'value',
        labelField: 'label',
        searchField: 'label',
      ...
      // Initialize Tom Select for city with lazy load
      window.cityTS = new TomSelect('#city', {
        valueField: 'value',
        labelField: 'label',
        searchField: 'label',
        options: [],
